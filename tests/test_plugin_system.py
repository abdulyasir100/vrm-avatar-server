...
Usage:
    python tests/test_plugin_system.py [--base http://localhost:8800]
...
BASE = sys.argv[2] if len(sys.argv) > 2 and sys.argv[1] == "--base" else "http://localhost:8800"
...
async def run_tests():
    async with httpx.AsyncClient() as c:
        ...
        leak_patterns = [
            "As the character", "I should", "I need to", "The user",
