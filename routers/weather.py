"""Weather router — API endpoint + cosmic character-themed frontend."""
...
<title>{{CHARACTER_NAME}} Weather</title>
<style>
...
const COMMENTS = {
  clear: [
    ...
    "Not a cloud in sight — perfect weather out there.",
  ],
  cloudy: [
...
function render(data) {
  ...
  document.getElementById('content').innerHTML = `
    ...
    <div class="character-comment">${pickComment(c.condition)}</div>
  `;
}
